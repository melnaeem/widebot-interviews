...
import { PlaygroundFlowComponent } from './playground-flow.component';
...
// Run the tests with:
// npm test -- --include="**/playground-flow.component.spec.ts"

describe('PlaygroundFlowComponent Race Condition', () => {
  let component: PlaygroundFlowComponent;
  let fixture: ComponentFixture<PlaygroundFlowComponent>;
  let flowEditorService: FlowEditorService;
  let flowsManagementService: FlowsManagementService;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [PlaygroundFlowComponent],
      imports: [FormsModule],
      providers: [FlowEditorService, FlowsManagementService],
    }).compileComponents();

    fixture = TestBed.createComponent(PlaygroundFlowComponent);
